        ...
        <div class="row">
            ...
            <div class="col-xl-10">
                <div class="main">
                    <h3>
                        Slaider 
                        <a href="http://localhost/project/admin/slaider/slaider_add.php" class="btn btn-success">Add Slaider</a>
                    ...
                    <div class="card">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img style="width: 70px;50px" src="../uploads/<?php echo $row['image'];?>">
                                </td>


                                <td>
                                    <a href="slaider_edit.php?id=<?php echo $row['id'];?>">Edit</a>
                                    <a href="slaider_delete.php?id=<?php echo $row['id'];?>">Delete</a>
                                </td>
                            </tr>
