        ...
        <div class="row">
            ...
            <div class="col-xl-10">
                <div class="main">
                    ...
                    $sql="select*from slaider where id='$id'";
                    ...
                    ?>
                        ...
                        <form action="slaider_update.php" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-success">Update Slaider</button>
                        </form>
                    </div>
                </div>
