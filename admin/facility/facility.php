        ...
        <div class="row">
            ...
            <div class="col-xl-10">
                <div class="main">
                    <h3>
                        Facility 
                        <a href="http://localhost/project/admin/facility/facility_add.php" class="btn btn-success">Add Facility</a>
                    ...
                    <div class="card">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="facility_edit.php?id=<?php echo $row['id'];?>">Edit</a>
                                    <a href="facility_delete.php?id=<?php echo $row['id'];?>">Delete</a>
                                </td>
                            </tr>
